...
import { Bell, ChevronDown, CircleHelp, Pencil, Search, SendToBack, UserRound } from "lucide-react";

const Navbar: React.FC = () => {
  return (
    <div className="flex justify-between px-3 md:px-14 py-2 md:py-4">
      <div className="flex items-center gap-4 md:gap-10 ">
        <div>
          <img src={logo} alt="Netflix-logo" className="w-12 md:w-20 lg:w-[88px]" />
        </div>
        ...
        <div className="flex gap-1 items-center relative group ">
          ...
          <div className="absolute right-0 top-full w-48 bg-black text-white rounded-sm shadow-lg p-4 hidden group-hover:block z-10">
            <ul className="flex flex-col gap-3">
              ...
              <li className="hover:text-gray-300 hover:underline cursor-pointer transition duration-200 ease-in-out text-sm">
                Sign out of Netflix
              </li>
            </ul>
          </div>
